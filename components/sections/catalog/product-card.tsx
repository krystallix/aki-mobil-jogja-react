...
export default function ProductCard({ product, onAddToCart }: ProductCardProps) {
    ...
    return (
        <div
            onClick={() => router.push(`/katalog/product/${product.id}`)}
        ...
        >
            ...
            <div className="p-3 space-y-2">
                ...
                <h3 className="text-base font-semibold line-clamp-2 leading-tight" title={product.nama}>
                    {product.nama}
                </h3>
                ...
                <div className="pt-2 border-t space-y-2">
                    ...
                    <div className="flex gap-2">
                        <Button
                            ...
                            onClick={(e) => {
                                e.stopPropagation();
                                router.push(`/katalog/product/${product.id}`);
                            }}
                        >
