...
export const metadata: Metadata = {
    ...
    keywords: [
        ...
        'toko aki bantul', 'aki mobil pleret bantul',
        'aki mobil delivery jogja', 'antar pasang aki jogja',
    ],
    alternates: {
        canonical: 'https://akimobiljogja.com',
    },
    openGraph: {
        title: 'Siswanto Aki Jogja - Servis Aki & Tukar Tambah Aki Mobil Bantul',
        description: 'Siswanto Aki Jogja (@siswantoaki.jogja) — servis aki, reparasi & tukar tambah aki mobil terpercaya di Bantul, Yogyakarta. Layanan antar pasang 24 jam, teknisi berpengalaman, harga transparan, garansi resmi.',
        ...
        images: [{
            ...
            width: 1200,
            height: 630,
            alt: 'Siswanto Aki Jogja - Servis Aki & Tukar Tambah Aki Mobil Bantul',
        }],
        locale: 'id_ID',
        type: 'website',
    },
    twitter: {
        ...
        title: 'Siswanto Aki Jogja - Servis Aki & Tukar Tambah Aki Mobil Bantul',
        description: 'Siswanto Aki Jogja (@siswantoaki.jogja) — servis aki, reparasi & tukar tambah aki mobil terpercaya di Bantul, Yogyakarta. Layanan antar pasang 24 jam.',
...
export default async function Page() {
    ...
    const jsonLd = {
        ...
        alternateName: ['Siswanto Aki', 'siswantoaki.jogja', 'Siswanto Aki Bantul'],
        image: 'https://akimobiljogja.com/og-image.jpg',
        description: 'Siswanto Aki Jogja — reparasi & tukar tambah aki mobil terpercaya di Bantul, Yogyakarta. Layanan antar pasang 24 jam.',
        address: {
            '@type': 'PostalAddress',
